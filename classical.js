...
(function () {
  ...
  var translations = {
    ...
    '.site-nav a[href="#resources"]': 'Links',
    ...
    '.update-note-text': 'Added a link library for politics, economics, geopolitics, strategy, futures, and research planning.',
    ...
    '#resources h2': 'Link Library',
    '#resources a[href="resources.html#world-analysis"] .card-kicker': 'Politics, Economics & Geopolitics',
    '#resources a[href="resources.html#world-analysis"] .link-value': 'Media for understanding global structures →',
    '#resources a[href="resources.html#strategy-futures"] .card-kicker': 'Strategy & Futures',
    '#resources a[href="resources.html#strategy-futures"] .link-value': 'States, technology, and long-term change →',
    '#resources a[href="resources.html#japanese-analysis"] .card-kicker': 'Analysis in Japanese',
    '#resources a[href="resources.html#japanese-analysis"] .link-value': 'Views of the world from Japan →',
    '#resources a[href="resources.html#research-planning"] .card-kicker': 'Research Planning',
    '#resources a[href="resources.html#research-planning"] .link-value': 'Resources for shaping questions and plans →',
    '#resources a[href="resources.html#research-community"] .card-kicker': 'Research & Community',
    '#resources a[href="resources.html#research-community"] .link-value': 'Research and community links →',
