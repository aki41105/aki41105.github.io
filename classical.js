...
(function () {
  ...
  var translations = {
    ...
    '.site-nav a[href="blog.html"]': 'Blog',
    ...
    '.update-note-text': 'Combined written posts and photo records on the blog.',
    ...
    '#resources a[href="resource-research-plan.html"] .card-kicker': 'Research Planning',
    '#resources a[href="resource-research-plan.html"] .link-value': 'Reference collection →',
