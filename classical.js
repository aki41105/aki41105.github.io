...
(function () {
  ...
  var translations = {
    ...
    '.work-interests-intro': 'I am interested in advanced development that supports globally competitive manufacturers and their products and businesses, working with a team toward shared goals to solve new technical challenges.',
    '.work-interests-list li:nth-child(1)': 'Solving technical challenges using AI, reinforcement learning, and simulation',
    '.work-interests-list li:nth-child(2)': 'Deploying autonomous and automated systems, including autonomous driving, in dynamic real-world environments',
    '.work-interests-list li:nth-child(3)': 'Companion AI and robots that build lasting relationships with people',
    '.work-interests-list li:nth-child(4)': 'Analyzing industries, markets, and corporate strategies in the context of technological change',
    ...
    '#publication-hai-2026 .publication-meta': 'Sakuramoto A., Hayashi T., Miyoshi R., Okafuji Y., Okada S.',
    '#publication-hai-2026 .publication-venue': '14th International Conference on Human-Agent Interaction (HAI 2026), Peer-reviewed poster paper, Accepted',
    '#publication-icmi-2026 .publication-title a': 'Multimodal Rapport Estimation in Real-World HRI',
    '#publication-icmi-2026 .publication-meta': 'Sakuramoto A., Hayashi T., Miyoshi R., Okafuji Y., Okada S.',
    '#publication-icmi-2026 .publication-venue': '28th ACM International Conference on Multimodal Interaction (ICMI 2026), Peer-reviewed, Accepted',
    '#publications .publication-list > div:nth-child(2) .publication-group-title': 'Domestic Conference',
    '#publication-miru-2026 .publication-title': 'A Multimodal Rapport Estimation Model for Evaluating Interaction Quality in Real-World HRI',
    '#publication-miru-2026 .publication-meta': 'Sakuramoto A., Hayashi T., Miyoshi R., Okafuji Y., Okada S.',
    '#publication-miru-2026 .publication-venue': 'Meeting on Image Recognition and Understanding (MIRU), Poster presentation (not peer-reviewed), Aug. 2026',
    '#publications .publication-list > div:nth-child(3) .publication-group-title': 'Awards and Grants',
    '#publication-jaist-scholarship .publication-title': 'JAIST Student Grant Scholarship, General Selection',
