const content = {
  ja: {
    ...
    resources: {
      ...
      entries: [
        { label: "🔒 内部資料サイト（本人専用）", value: "ローカルで開く — このMac限定", href: "http://localhost:8100/", icon: "link" },
        { label: "🔒 内部資料（GitHub）", value: "外出先はこちら — 要ログイン", href: "https://github.com/aki41105/my-docs", icon: "github" },
  ...
  en: {
    ...
    resources: {
      ...
      entries: [
        { label: "🔒 Private Notes Site (owner only)", value: "Local — this Mac only", href: "http://localhost:8100/", icon: "link" },
        { label: "🔒 Private Notes (GitHub)", value: "On the go — sign-in required", href: "https://github.com/aki41105/my-docs", icon: "github" },
