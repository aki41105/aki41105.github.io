...
(function () {
  ...
  if (
    ...
    /^#(about|research|career|memberships|publications|resources|contact)$/.test(location.hash)
  ) {
  ...
  if (sceneControls) {
    ...
    sceneControls.addEventListener("focusout", function () {
  ...
  var savedTheme = null;
  try {
    savedTheme = localStorage.getItem("classical-theme");
  } catch (error) {}
  ...
  if (themeToggle) {
    themeToggle.addEventListener("click", function () {
      ...
      try {
        localStorage.setItem("classical-theme", dark ? "light" : "dark");
      } catch (error) {}
    });
  }
  ...
  if (!reduced) {
    ...
    if (stroll)
      stroll.addEventListener("animationiteration", function () {
        stroll.classList.toggle("flip");
      });
  }

  Array.prototype.forEach.call(
    document.querySelectorAll(".photo-detail-figure img, .analysis-figure > img"),
    function (image) {
  ...
  Array.prototype.forEach.call(
    document.querySelectorAll(".resource-reference-card"),
    function (card) {
      ...
      var resourceUrl;
      try {
        resourceUrl = new URL(link.href);
      } catch (error) {
        return;
      }
      var hostname = resourceUrl.hostname.replace(/^www\./, "");
      var iconSlug = hostname
        .toLowerCase()
        .replace(/[^a-z0-9]+/g, "-")
        .replace(/^-|-$/g, "");
  ...
  var translations = {
    ...
    ".blog-index > .photo-detail-copy .summary":
    ...
    ".garden-intro > .summary":
      "Reading research, exploring mathematics, and thinking about technology and society. A place to keep discoveries along the way.",
    '.garden-entry[href="profile.html"] h2': "About",
    '.garden-entry[href="profile.html"] p':
      "Research interests, experience, publications, and activities.",
    '.garden-entry[href="blog.html"] h2': "Blog",
    '.garden-entry[href="blog.html"] p':
      "Notes on research, mathematics and statistics, technology and AI, and society.",
    ...
    ".hero .summary":
      "I study human-robot interaction, social signal processing, and multimodal interaction, with a focus on understanding the quality of human-robot relationships in real-world HRI.",
    ...
    ".work-interests-list li:nth-child(4)":
      "Developing companion AI and robots that build lasting relationships with people",
    ".work-interests-list li:nth-child(5)":
    ...
    "#research .lede":
      "I study real-world HRI through social signal processing and multimodal interaction. In particular, I aim to evaluate interaction quality quantitatively by estimating rapport—the quality of the relationship—in customer-service dialogue.",
    ...
    "#education .timeline-item:nth-child(1) .timeline-title":
      "Japan Advanced Institute of Science and Technology (JAIST), M.S. Student, AI Science Area",
    "#education .timeline-item:nth-child(2) .timeline-year": "Apr. 2021 – Mar. 2025",
    "#education .timeline-item:nth-child(2) .timeline-title a":
      "University of Toyama, B.E., Electrical and Electronic Engineering Course, Faculty of Engineering",
    ...
    "#research-activities .timeline-item:nth-child(1) .timeline-title":
      "Joint research with CyberAgent AI Lab. Studying real-world HRI and interaction quality evaluation using in-store customer-service robot interaction data.",
    "#research-activities .timeline-item:nth-child(2) .timeline-year": "Aug. 2025 – Jan. 2026",
    "#research-activities .timeline-item:nth-child(2) .timeline-title a":
      "Preserving lessons from the Noto Peninsula Earthquake through digital twin technology",
    "#research-activities .timeline-item:nth-child(2) .timeline-detail":
      "Conducted interviews in Ipponsugi Shopping Street, Nanao, organized local challenges and lessons from the earthquake, and examined ways to preserve and share those findings with digital twin technology in a final report.",
    "#experience .career-group-title": "Experience",
    "#research-activities .timeline-item:nth-child(3) .timeline-year": "Oct. 2023 – Mar. 2025",
    "#research-activities .timeline-item:nth-child(3) .timeline-title":
      "University of Toyama: Investigating an LSTM-based deep learning model for earthquake prediction",
    "#research-activities .timeline-item:nth-child(3) .timeline-detail":
      "Under the supervision of 藤井雅文, developed an LSTM model using electromagnetic observations to predict seismic intensity and magnitude. Created datasets, explored hyperparameters, evaluated prediction performance, and identified areas for improvement.",

    "#experience .timeline-item:nth-child(1) .timeline-year": "Sep. 2025",
    "#experience .timeline-item:nth-child(1) .timeline-title a":
      "Engineering Internship, Nissan Motor Co., Ltd.",
    "#experience .timeline-item:nth-child(1) .timeline-detail":
      "Participated in a five-day vehicle performance internship focused on autonomous driving and advanced driver-assistance system testing (AD/ADAS).",
    "#experience .timeline-item:nth-child(2) .timeline-year": "Aug. 2025 – Sep. 2025",
    "#experience .timeline-item:nth-child(2) .timeline-title a":
      "2025 Internship, FUJI Corporation",
    "#experience .timeline-item:nth-child(2) .timeline-detail":
      "Worked for three weeks on AI-based image inspection for defects occurring inside solder paste printers, including data collection and algorithm development.",
    "#experience .timeline-item:nth-child(3) .timeline-year": "Feb. 2024 – Mar. 2024",
    "#experience .timeline-item:nth-child(3) .timeline-title a":
      "Internship, Robot Learning Laboratory, Nara Institute of Science and Technology (NAIST)",
    "#experience .timeline-item:nth-child(3) .timeline-detail":
      "Worked on robot manipulation tasks using reinforcement learning for approximately four weeks.",
    "#experience .timeline-item:nth-child(4) .timeline-title a":
      "NHK Student Robocon 2023 Finalist",
    "#experience .timeline-item:nth-child(4) .timeline-detail":
    ...
    "#experience .timeline-item:nth-child(5) .timeline-title a":
      "Participant, 24th World Scout Jamboree (24WSJ)",
    "#experience .timeline-item:nth-child(5) .timeline-detail":
      "Lived and collaborated with participants from many countries at the World Scout Jamboree in the United States.",
    ...
    "#publications .publication-list > div:nth-child(1) .publication-group-title":
      "International Conference",
    "#publication-hai-2026 .publication-meta":
    ...
    "#publication-icmi-2026 .publication-title a":
    ...
    "#publication-miru-2026 .publication-meta":
      "Sakuramoto A., Hayashi T., Miyoshi R., Okafuji Y., Okada S.",
    "#publication-miru-2026 .publication-venue":
      "Meeting on Image Recognition and Understanding (MIRU), Poster presentation (not peer-reviewed), Aug. 2026",
    "#publications .publication-list > div:nth-child(3) .publication-group-title":
      "Awards and Grants",
    ...
    '#resources a[href="resources.html#world-analysis"] .card-kicker':
      "Politics, Economics & Geopolitics",
    '#resources a[href="resources.html#world-analysis"] .link-value':
      "Power, institutions, and the global economy",
    '#resources a[href="resources.html#business-industry"] .card-kicker': "Business & Industry",
    '#resources a[href="resources.html#business-industry"] .link-value':
      "Companies, competition, and industry structures",
    '#resources a[href="resources.html#research-technology"] .card-kicker': "Research & Technology",
    '#resources a[href="resources.html#research-technology"] .link-value':
      "Research and technology trends",
    '#resources a[href="resources.html#culture-entertainment"] .card-kicker':
      "Culture & Entertainment",
    '#resources a[href="resources.html#culture-entertainment"] .link-value':
      "Works, culture, and entertainment industries",
    '#resources a[href="resources.html#relationships-romance"] .card-kicker':
      "Society & Relationships",
    '#resources a[href="resources.html#relationships-romance"] .link-value':
      "Care, intimacy, relationships, and society",
    ...
    '#resources a[href="resource-archive.html"] .link-value':
      "Data, sources, research planning, and presentations",
    ...
    '#contact a[href="https://www.jaist.ac.jp/~okada-s/index.html"] .contact-label-text':
      "Okada Laboratory",
    '#contact a[href="https://www.jaist.ac.jp/~okada-s/index.html"] .link-value': "Lab Website",
    '.footer-links a[href="https://aki-private.sakuramoto-may.workers.dev/personal.html"]':
      "Personal",
  ...
  try {
    currentLanguage = localStorage.getItem("classical-lang") || "ja";
  } catch (error) {}
  ...
  function applyLanguage(language) {
    Object.keys(translations).forEach(function (selector) {
      ...
      if (!element) return;
      element.textContent =
        language === "en" ? translations[selector] : element.getAttribute("data-ja-text");
    });
    currentLanguage = language;
    document.documentElement.lang = language;
    document.title =
      language === "en" &&
      (document.querySelector(".hero") || document.querySelector(".scene-hero"))
        ? "AKI NOTES | Akihiro Sakuramoto"
        : japaneseTitle;
    if (descriptionMeta) {
    ...
    languageToggle.setAttribute(
      "aria-label",
      language === "en" ? "日本語表示に切り替え" : "Switch to English",
    );
  }
  ...
  if (languageToggle) {
    languageToggle.addEventListener("click", function () {
      ...
      try {
        localStorage.setItem("classical-lang", currentLanguage);
      } catch (error) {}
    });
